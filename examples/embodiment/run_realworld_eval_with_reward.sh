...
export SRC_FILE="${EMBODIED_PATH}/eval_realworld_with_reward.py"
export PYTHONPATH="${REPO_PATH}:${PYTHONPATH:-}"
export HYDRA_FULL_ERROR=1
export RLINF_SKIP_ROS_CLEANUP="${RLINF_SKIP_ROS_CLEANUP:-1}"
export RLINF_KEYBOARD_DEVICE=/dev/input/event15
if [ $# -lt 1 ]; then
...
MEGA_LOG_FILE="${LOG_DIR}/run_realworld_eval_with_reward.log"
mkdir -p "${LOG_DIR}"
